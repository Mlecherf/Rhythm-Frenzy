...
function pressKey(key){
    ...
    if (key.key == "a" && piano1.classList == "piano1 tile" ){
        //dans la case final
        if(pianovalue1<=700 && finishTop1 == 700){
                audio.play()
                score=score+250
    ...
    if (key.key == "z" && piano2.classList == "piano2 tile" ){
        if(pianovalue2<=700 && pianovalue2 <800&& finishTop2 == 700){
                    audio.play()
                    score=score+250
                    Score.innerHTML = score
                    Lose.innerHTML = "keep going !"
    ...
    if (key.key == "e" && piano3.classList == "piano3 tile" ){
        if(pianovalue3<=700 && pianovalue3 <800&& finishTop3 == 700){
                    audio.play()
                    score=score+250
                    Score.innerHTML = score
                    Lose.innerHTML = "keep going !"
    ...
    if (key.key == "r" && piano4.classList == "piano4 tile" ){
        if(pianovalue4<=700 && pianovalue4 <800&& finishTop4 == 700){
                audio.play()
                score=score+250
                Score.innerHTML = score
                Lose.innerHTML = "keep going !"
...
// function stopIt(){
//     if (pianovalue1>=700 && pianovalue1 <800){
...
//             if (pianovalue2< 700 || pianovalue>=800){
//                 piano2.style.backgroundColor = "green"
//             }
//             if (pianovalue2< 700 || pianovalue2>=800){
//                 piano2.style.backgroundColor = "red"
//                 piano1.classList.remove("tile")
//                 piano2.classList.remove("tile")
//                 piano3.classList.remove("tile")
...
//             if (pianovalue3< 700 || pianovalue3>=800){
...
//             if (pianovalue4< 700 || pianovalue4>=800){
//                 piano4.style.backgroundColor = "green"
//             }
//             if (pianovalue4< 700 || pianovalue4>=800 ){
//                 cancelAnimationFrame(color())
//                 piano4.style.backgroundColor = "red"
//                 piano1.classList.remove("tile")
//                 piano2.classList.remove("tile")
//                 piano3.classList.remove("tile")
